package com.dsy.dsu.BusinessLogicForApps.JsonSerializerAndDeserializer;
 ...
 return  РезультатОперацииBurkUPDATE.size();
    ...
    private SQLiteStatement методGetSqliteStatementForInsert(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindString(1, jsonNodeParentMAP.get("name").asText().trim());//"name"
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("region").intValue());//"name"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("boss").intValue());//"name"




            if (jsonNodeParentMAP.has("kod")) {
                sqLiteStatementInsert.bindString(4, jsonNodeParentMAP.get("kod").asText());//"date_update"
            }else {
            ...
            sqLiteStatementInsert.bindLong(7, jsonNodeParentMAP.get("closed").intValue());//"name"
    ...
    private SQLiteStatement методGetSqliteStatementForUpdate(@NonNull SQLiteDatabase Create_Database_СамаБАзаSQLite,
        ...
        try{
            ...
            sqLiteStatementInsert.bindLong(2, jsonNodeParentMAP.get("region").intValue());//"name"
            sqLiteStatementInsert.bindLong(3, jsonNodeParentMAP.get("boss").intValue());//"name"
            sqLiteStatementInsert.bindString(4, jsonNodeParentMAP.get("kod").asText());//"name"
            sqLiteStatementInsert.bindString(5, jsonNodeParentMAP.get("date_update").asText());//"date_update"
            sqLiteStatementInsert.bindLong(6, jsonNodeParentMAP.get("user_update").intValue());//"user_update"
            sqLiteStatementInsert.bindLong(7, jsonNodeParentMAP.get("closed").intValue());//"name"
            sqLiteStatementInsert.bindLong(8, jsonNodeParentMAP.get("current_table").longValue());//"current_table"
